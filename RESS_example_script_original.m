...
clear
addpath('C:\Users\Richard Naar\Documents\dok\ssvep\Proof of concept\Kirjandus\Technical\Rhythmic entrainment source separation\ress\'); % data folder
%% specify parameters
...
tidx = dsearchn(EEG.times',[500 5000]'); % we use data from .5-10 seconds, to avoid using the stimulus transient
